...
| -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Shared card container                        | Final Today, Backlog, project, and list designs                                                                                  | Extract a small shared shell only where heading, actions, content, spacing, and color treatment match. Keep individual task rows in JMTaskItem.                          |
