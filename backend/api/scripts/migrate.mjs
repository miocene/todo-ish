...
const client = new Client({ password, options: process.env.PGOPTIONS, connectionTimeoutMillis: 5000 });
await client.connect();
try {
  await runMigrations(client, process.env.MIGRATION_DIRECTORY ?? "/migrations", {
